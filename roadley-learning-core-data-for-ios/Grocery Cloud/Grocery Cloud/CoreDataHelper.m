...
#warning To enable StackMob, enter the public key of your own application below. Don't forget to generate a StackMob Schema as per Chapter 16 of Learning Core Data for iOS by Tim Roadley
    ...
    [_stackMobClient.session.networkMonitor setNetworkStatusChangeBlockWithCachePolicyReturn:^SMCachePolicy(SMNetworkStatus status){
